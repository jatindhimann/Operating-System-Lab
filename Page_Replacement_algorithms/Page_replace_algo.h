...
public:
    ...
    void LFU(vector<int> &reference_string, int num_frames)
    {
    ...
    void MFU(vector<int> &reference_string, int num_frames)
    {
        int misses = 0;
        int hits = 0;
    ...
    // Alogrithm: Optimal
    void OPT(vector<int> &reference_string, int num_frames)
    {
